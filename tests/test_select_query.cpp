...
TEST_F(QuerySelectSwapTest, Select_All_NoWhere_PrintsInKeyOrder)
{
  ...
  // If out is empty, your SelectQuery likely prints to cout instead of returning a displayable
  // result.
  ASSERT_FALSE(out.empty())
      << "SelectQuery should return a displayable QueryResult (e.g., TextRowsResult).";
  const std::string expect = "( Bill_Gates 2014 400812312 )\n"
